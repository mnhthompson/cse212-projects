...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: bob is wanted gets SUE fixed the loading process
    ...
    // Defect(s) Found:  tim is wanted gets SUE changed how immortals are found
